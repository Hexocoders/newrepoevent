      ...
      <nav className="flex-1 px-4 space-y-2">
        <Link 
          ...
          className={`flex items-center px-4 py-3 rounded-lg ${
            isActive('/dashboard') ? 'text-pink-500 bg-pink-50' : 'text-gray-600 hover:bg-gray-50'
          }`}
        >
        ...
        <Link 
          href="/calendar" 
          className={`flex items-center px-4 py-3 rounded-lg ${
            isActive('/calendar') ? 'text-pink-500 bg-pink-50' : 'text-gray-600 hover:bg-gray-50'
          }`}
        >
        ...
        <Link 
          href="/my-events" 
          className={`flex items-center px-4 py-3 rounded-lg ${
            isActive('/my-events') ? 'text-pink-500 bg-pink-50' : 'text-gray-600 hover:bg-gray-50'
          }`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Link 
          href="/payment" 
          className={`flex items-center px-4 py-3 rounded-lg ${
            isActive('/payment') ? 'text-pink-500 bg-pink-50' : 'text-gray-600 hover:bg-gray-50'
          }`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <Link 
          href="/messages" 
          className={`flex items-center px-4 py-3 rounded-lg ${
            isActive('/messages') ? 'text-pink-500 bg-pink-50' : 'text-gray-600 hover:bg-gray-50'
          }`}
        >
        ...
        <Link 
          href="/settings" 
          className={`flex items-center px-4 py-3 rounded-lg ${
            isActive('/settings') ? 'text-pink-500 bg-pink-50' : 'text-gray-600 hover:bg-gray-50'
          }`}
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
